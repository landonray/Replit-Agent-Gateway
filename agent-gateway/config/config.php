...
return [
    ...
    'default_model' => $_ENV['DEFAULT_MODEL'] ?? 'claude-opus-4-6',

    // LLM Judge settings
    // Judge defaults to the same model as the primary agent. Override JUDGE_MODEL
    // to a cheaper model once confirmed your LLM Gateway supports it.
    'judge_model'   => $_ENV['JUDGE_MODEL'] ?? ($_ENV['DEFAULT_MODEL'] ?? 'claude-opus-4-6'),
